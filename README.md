...
- The Dialogflow reference connection code server public hostname and port (as **`DF_CONNECTING_SERVER`**) without any http:// nor https:// prefix, without any trailing slash, or sub-path</br>
